...
case class SystemInformation(
                              system_id : String, language : String, name : String, short_name : Option[String], operator : Option[String], url : Option[String], purchase_url : Option[String], start_date : Option[String], phone_number : Option[String], email : Option[String], timezone : String, license_url : Option[String]

                            )
object SystemInformation{
  implicit val decode : Decoder[SystemInformation] = new Decoder[SystemInformation] {
    override def apply(c: HCursor): Result[SystemInformation] =
      ...
      for {
        ...
        yield {
          SystemInformation(system_id, language, name, short_name, operator, url, purchase_url, start_date, phone_number, email, timezone, license_url)
        }
  }
